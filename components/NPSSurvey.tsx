...
export function NPSSurvey({ visible = false, onClose, userId, isPaidUser }: NPSSurveyProps) {
  ...
  const handleDismiss = () => {
    captureEvent('nps_survey_dismissed', { score_selected: score });
    onClose?.();
  };
  ...
  return (
    <Modal visible={visible} transparent animationType="slide" onRequestClose={handleDismiss}>
      <Pressable style={{ flex: 1, backgroundColor: colors.overlay, justifyContent: 'flex-end' }} onPress={handleDismiss}>
        <Pressable onPress={() => {}} style={{ backgroundColor: surfaceDark, borderTopLeftRadius: 24, borderTopRightRadius: 24, padding: 24 }}>
          {/* Header */}
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
            <Text style={{ color: '#FFFFFF', fontSize: 18, fontWeight: '700' }}>How likely are you to recommend {gasConfig.app.name}?</Text>
          ...
          <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginBottom: 20 }}>
            ...
            <Text style={{ color: colors.positive, fontSize: 11 }}>Very likely</Text>
          </View>
          ...
          {score !== null && (
            <TextInput
              ...
              numberOfLines={3}
              style={{
                backgroundColor: borderDark, borderRadius: 12,
          ...
          {submitted ? (
            <View style={{ alignItems: 'center', paddingVertical: 16 }}>
              <ThumbsUp size={32} color={colors.positive} />
              <Text style={{ color: colors.positive, marginTop: 8, fontWeight: '600' }}>Thanks for your feedback!</Text>
            </View>
          ) : (
            <TouchableOpacity
              ...
              style={{
                backgroundColor: primary, borderRadius: 12, padding: 14,
                alignItems: 'center', opacity: score === null || submitting ? 0.5 : 1,
              }}
